...
let backgroundNamesArray: Array<string> = [
 ...
 */
function setNewBackground(array: Array<string>): void {
...
let avatarImagePath: string = "static/img/avatars/";
let avatarImageNameArray: Array<string> = [
